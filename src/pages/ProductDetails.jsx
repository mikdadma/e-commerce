    ...
    <main className="min-h-screen bg-gray-50">
      <div className="mx-auto w-full max-w-7xl px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        ...
        <div className="mb-6">
          <button
            onClick={() => navigate("/")}
            className="mb-4 inline-flex items-center gap-2 text-sm font-semibold text-gray-500 transition duration-300 hover:text-green-600"
          >
            ← Back to Products
          </button>
        ...
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
          ...
          <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
            <div className="relative flex min-h-[320px] items-center justify-center bg-gray-50 p-6 sm:min-h-[450px] sm:p-10">
              ...
              <img
                src={product.image}
                alt={product.name}
                className="h-72 w-full object-contain transition duration-500 hover:scale-105 sm:h-96"
              />
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm sm:p-7 lg:p-8">
            ...
            {product.stock === 0 && (
              <p className="mb-6 rounded-xl border border-red-100 bg-red-50 p-4 text-sm font-semibold leading-6 text-red-600">
            ...
            <div className="mt-7 rounded-2xl border border-gray-200 bg-gray-50 p-5">
              ...
              <div className="flex w-fit items-center rounded-xl border border-gray-200 bg-white p-1 shadow-sm">
                ...
                <button
                  onClick={() =>
                    setQuantity(
                      (prev) => Math.min(prev + 1, product.stock)
                    )
                  }
            ...
            <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2">
              ...
              <button
                ...
                className="w-full rounded-xl bg-green-600 px-5 py-3.5 font-semibold text-white shadow-sm transition duration-300 hover:bg-green-700 hover:shadow-md disabled:cursor-not-allowed disabled:bg-gray-400 disabled:shadow-none"
              >
                {product.stock === 0
                  ? "Out of Stock"
                  : "Add to Cart"}
              ...
              <button
                ...
                className="w-full rounded-xl bg-gray-900 px-5 py-3.5 font-semibold text-white shadow-sm transition duration-300 hover:bg-gray-800 hover:shadow-md disabled:cursor-not-allowed disabled:bg-gray-400 disabled:shadow-none"
              >
                {product.stock === 0
                  ? "Out of Stock"
                  : "Buy Now"}
            ...
            <div className="mt-6 border-t border-gray-100 pt-6">
              <button
                onClick={() => navigate("/")}
                className="w-full rounded-xl bg-gray-100 px-5 py-3.5 font-semibold text-gray-700 transition duration-300 hover:bg-gray-200 sm:w-auto sm:min-w-48"
              >
                ← Back to Products
              </button>
            </div>
